...
if ( ! function_exists( 'mbs_setup' ) ) :
	...
	function mbs_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'mbs_custom_background_args', array(
...
function mbs_scripts() {
	...
	wp_enqueue_script( 'mbs-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'mbs-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
